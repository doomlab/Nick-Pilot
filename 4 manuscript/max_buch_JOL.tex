...
were predictive of recall. Overall, our findings indicate the degree to
which the processing of associative, semantic, and thematic information
...
and association, this presence of these interactions suggests that
connections exist between these networks, linking them to one another.
As such, we suggest a three-tiered hypothesis of these memory systems as
a means of explaining the interconnections present between them. First,
information enters the semantic memory network, which processes features
...
both the item and its place world relative to other concepts. Viewing
this model through the lens of semantic memory, it is somewhat similar
in nature to dynamic attractor models (Hopfield, 1982; M. N. Jones et
al., 2015; McLeod, Shallice, \& Plaut, 2000). One of the defining
features of dynamic attractor models is that they allow for some type of
bidirectionally or feedback between connections. In the study of
semantic memory, these models are useful for taking into account
multiple restraints (such as links between semantics and the orthography
of the concept in question) Our hypothesis extends this idea as means of
...
general contexts in which it typically appears. Ultimately, further
studies of recall and judgment within the framework of these memory
networks will be needed to further explore this notion.
