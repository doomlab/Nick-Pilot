...
tableprint[2 , ] = c("Associative DA", apa(hyp1results$AFSG$m, 2, F),
...
tableprint[3 , ] = c("Associative IA", apa(hyp1results$ACOS$m, 2, F),
...
tableprint[5 , ] = c("Semantic DA", apa(hyp1results$SFSG$m, 2, F),
...
tableprint[6 , ] = c("Semantic IA", apa(hyp1results$SCOS$m, 2, F),
...
tableprint[8 , ] = c("Thematic DA", apa(hyp1results$TFSG$m, 2, F),
...
tableprint[9 , ] = c("Thematic IA", apa(hyp1results$TCOS$m, 2, F),
