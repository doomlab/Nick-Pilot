...
tableprint[1:4, 1] = c("(Intercept)", "A-Indirect", "A-Direct", "A-Intercept")

tableprint[5:8, 2:5] = coef(summary(semh4))
tableprint[5:8, 1] = c("(Intercept)", "S-Indirect", "S-Direct", "S-Intercept")

tableprint[9:12, 2:5] = coef(summary(themeh4))
tableprint[9:12, 1] = c("(Intercept)", "T-Indirect", "T-Direct", "T-Intercept")
